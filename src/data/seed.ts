...
export const SEED_AGENTS: Agent[] = [
  {
    ...
    model: "Claude Opus",
    role: "Generalist",
    instructions: "Usa TypeScript strict mode e tipi espliciti ovunque. Funzioni piccole e pure, niente `any`. Ogni funzione esportata deve avere un tipo di ritorno dichiarato.",
    status: "working",
    position: [0, 3.0],
    target: null,
  ...
  },
  {
    ...
    model: "Claude Sonnet",
    role: "Tester",
    instructions: "Testa sempre i casi limite e gli scenari di errore oltre al percorso felice. Nomi chiari: describe('ComponenteX', () => it('fa Y quando Z')). Almeno un test negativo per ogni funzione.",
    status: "done",
    position: [3.0, -2.4],
    target: null,
  ...
  },
  {
    ...
    model: "Claude Sonnet",
    role: "Revisore",
    instructions: "Nelle review evidenzia prima i problemi di sicurezza, poi performance, poi stile. Per ogni problema proponi un esempio di codice migliorato. Sii costruttivo, non punitivo.",
    status: "review",
    position: [5.0, -1.6],
    target: null,
  ...
  },
  {
    ...
    model: "Claude Opus",
    role: "Architetto",
    instructions: "Prima di progettare, leggi la struttura del progetto con gh_list_files. Preferisci semplicità a eleganza. Documenta le decisioni architetturali con il loro perché, non solo il cosa.",
    status: "working",
    position: [-1.6, -2.4],
    target: null,
  ...
  },
  {
    ...
    model: "Claude Haiku",
    role: "Documentatore",
    instructions: "Documenta con esempi pratici e codice funzionante. Usa titoli H2/H3, bullet list e blocchi di codice. Massimo 3 paragrafi per sezione — la brevità è virtù.",
    status: "done",
    position: [6.0, 1.4],
    target: null,
