...
export const LEVEL_META: Record<LogLevel, { text: string; label: string }> = {
  INFO: { text: "text-sky-300", label: "INFO" },
  SUCCESS: { text: "text-emerald-300", label: "SUCCESS" },
  WARN: { text: "text-amber-300", label: "WARN" },
  ERROR: { text: "text-rose-300", label: "ERROR" },
  IDLE: { text: "text-slate-400", label: "IDLE" },
};
